...
import { BarChart3, Sparkles, TrendingUp, TableProperties, Settings, ChevronLeft, ChevronRight } from "lucide-react";
...
export function Sidebar({ onNavigate, collapsed = false, onCollapsedChange }: SidebarProps) {
  ...
  return (
    <aside className={cn(
      "min-h-screen border-r border-sidebar-border bg-sidebar transition-all duration-300 ease-in-out flex flex-col",
      collapsed ? "w-16" : "w-64"
    )}>
      {/* Logo */}
      <div className={cn(
